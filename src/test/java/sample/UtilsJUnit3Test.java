...
public class UtilsJUnit3Test extends TestCase {
     ...
     * this test class. The test initialization method is recognized by the
     * following attributes: its name is &quot;{@code setUp}&quot;, it has no
     * arguments, it has {
     *
     * @void} return type and it is protected or public.
     */
    @Override
    ...
    /**
     * Test initialization method. It is executed after each test method of this
     * test class. The test shutdown method is recognized by the following
     * attributes: its name is &quot;{@code tearDown}&quot;, it has no
     * arguments, it has {
     *
     * @void} return type and it is protected or public.
     */
     ...
     * name of the test method such that it does not begin with &quot;test&quot;
     * - the result is that it is not executed.
